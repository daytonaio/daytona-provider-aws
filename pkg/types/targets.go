...
func GetTargetConfigManifest() *provider.TargetConfigManifest {
	return &provider.TargetConfigManifest{
		"Region": provider.TargetConfigProperty{
		...
		"Device Name": provider.TargetConfigProperty{
			Type:         provider.TargetConfigPropertyTypeString,
		...
		"Volume Size": provider.TargetConfigProperty{
		...
		"Secret Access Key": provider.TargetConfigProperty{
			Type:        provider.TargetConfigPropertyTypeString,
			InputMasked: true,
			Description: "Find this in the AWS Console under \"My Security Credentials\"\nhttps://aws.amazon.com/premiumsupport/knowledge-center/manage-access-keys/\n" +
